      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-lg-4" style="text-align:end;">
            <a href="{{url('download')}}" style="margin-right: 25px;"><i style="color: #000;font-size: 30px;" class="far fa-file-pdf"></i></a>
            <a style="color: #000;" href="{{url('/view_enquiry')}}"><i data-feather="arrow-left-circle"></i></a>
          </div>
        </div>
      </div>
      <div class="card-body">
